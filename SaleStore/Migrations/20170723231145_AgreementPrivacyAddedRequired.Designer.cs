...
namespace SaleStore.Migrations
{
    ...
    [Migration("20170723231145_AgreementPrivacyAddedRequired")]
    partial class AgreementPrivacyAddedRequired
    {
            ...
            modelBuilder.Entity("SaleStore.Models.Company", b =>
                {
                    ...
                    b.Property<bool>("CompanyAcceptAgreement");
            ...
            modelBuilder.Entity("SaleStore.Models.Setting", b =>
                {
                    ...
                    b.Property<string>("AgreementPrivacy");
